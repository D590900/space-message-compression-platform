...
Optional neural codecs remain disabled until a manifest in this directory contains immutable, independently verified code and parameter provenance and a real decoder runtime is registered. Builds and imports never download weights. CoD-Lite, SNAC, Mimi, EnCodec 48 kHz, detector-free LivePortrait, Cool-Chic image/video and HiNeRV are enabled and pin their published CUDA and CPU runtimes by digest.
