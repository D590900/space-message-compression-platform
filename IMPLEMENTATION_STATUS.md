...
| M1 — vertical slice      | In progress | Clerk control plane with org-admin mutations, transactional job outbox, crash-recovering Valkey worker, signed upload, verified decompression, capsule E2E and durable external-mutation idempotency; live Clerk E2E and dashboard remain                                 |
...
| M5 — productization      | In progress | Session-backed resource collections, configurable non-weakenable quality gates, original retention, TypeScript/Python SDKs, public CLI including Rust capsule extraction, signed durable webhooks, quotas/rate limits, observability and operator docs; dashboard remains |
