...
| M1 — vertical slice      | In progress | Clerk control plane, crash-recovering Valkey worker, signed upload, verified decompression, capsule E2E, durable external-mutation idempotency and Compose services; live Clerk E2E and dashboard remain                 |
...
| M5 — productization      | In progress | TypeScript/Python SDKs, public CLI, signed durable webhooks, atomic quotas and tenant/key cost limits, media admission ceilings, protected metrics, OTLP propagation, worker health and operator docs; dashboard remains |
