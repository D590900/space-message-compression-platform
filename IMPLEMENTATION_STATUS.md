...
| M3 — neural codecs       | In progress | CoD-Lite 0.0312-bpp, SNAC 24 kHz, Mimi 24 kHz, EnCodec 48 kHz and detector-free LivePortrait are enabled with immutable CUDA/CPU decoders. Cool-Chic image/video and HiNeRV replace the three checkpoint-blocked families with tested per-asset runtimes; they remain fail-closed until the scanned images are published and pinned by digest |
