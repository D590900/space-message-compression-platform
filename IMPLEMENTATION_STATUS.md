...
| M6 — release             | In progress | Initial PR merged with all post-merge checks green; pinned CI/security/image/release workflows, reproducible CPU benchmarks, source/image security audit, dependency-license inventory, protected real-Clerk lifecycle test and pre-tag exact-image candidate audit | Merge release hardening, run final candidate gates, review SBOMs and tag v0.1.0 |
