...
| M3 — neural codecs       | In progress | CoD-Lite 0.0312-bpp has approved MIT weights, a real adapter, hash-locked CUDA runtime, external verified cache and immutable decoder digest; seven other families remain fail-closed pending checkpoint-specific approval                                        |
