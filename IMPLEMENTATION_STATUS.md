...
| M3 — neural codecs       | In progress | CoD-Lite 0.0312-bpp, SNAC 24 kHz, Mimi 24 kHz and EnCodec 48 kHz are enabled with immutable CUDA/CPU decoders, external hash-verified weights and scanned, attested runtimes; four other families remain fail-closed pending checkpoint-specific approval         |
