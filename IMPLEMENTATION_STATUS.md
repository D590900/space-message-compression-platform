...
| M3 — neural codecs       | In progress | CoD-Lite 0.0312-bpp and SNAC 24 kHz are enabled with immutable CUDA and CPU decoders; Mimi 24 kHz has an approved, hash-pinned checkpoint and locally verified real adapter but remains fail-closed pending runtime publication; five other families await checkpoint-specific approval |
