...
| M3 — neural codecs       | In progress | CoD-Lite 0.0312-bpp is enabled with an immutable CUDA decoder; SNAC 24 kHz has approved MIT weights, exact hashes, a real adapter and a hash-locked CPU runtime definition pending publication; six other families remain fail-closed pending checkpoint-specific approval |
