...
| M3 — neural codecs       | In progress | CoD-Lite 0.0312-bpp, SNAC 24 kHz and Mimi 24 kHz are enabled with immutable CUDA/CPU decoders, external hash-verified weights and scanned, attested runtimes; five other families remain fail-closed pending checkpoint-specific approval                         |
