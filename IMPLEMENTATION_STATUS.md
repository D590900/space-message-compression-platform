...
| M3 — neural codecs       | Complete    | CoD-Lite 0.0312-bpp, SNAC 24 kHz, Mimi 24 kHz, EnCodec 48 kHz, detector-free LivePortrait, Cool-Chic image/video and HiNeRV are enabled with immutable CUDA/CPU decoders. The three replacement codecs use tested per-asset parameters and published, scanned runtimes pinned by digest |
