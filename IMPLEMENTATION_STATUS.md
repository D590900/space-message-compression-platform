...
| M3 — neural codecs       | In progress | CoD-Lite 0.0312-bpp, SNAC 24 kHz, Mimi 24 kHz, EnCodec 48 kHz and detector-free LivePortrait are enabled with immutable CUDA/CPU decoders, external hash-verified weights and scanned, attested runtimes; three other families remain fail-closed                 |
